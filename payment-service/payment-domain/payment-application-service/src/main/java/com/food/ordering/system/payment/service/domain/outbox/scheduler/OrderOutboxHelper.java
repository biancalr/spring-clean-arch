...
public class OrderOutboxHelper {
    ...
    public Optional<List<OrderOutboxMessage>> getOrderOutboxMessageByOutboxStatus(
        ...
        return orderOutboxRepository
                .findByTypeAndOutboxStatus(ORDER_SAGA_NAME, outboxStatus);
    }

    @Transactional
    public void deleteOrderOutboxMessageByOutboxStatus(OutboxStatus outboxStatus) {
        orderOutboxRepository
                .deleteByTypeAndOutboxStatus(ORDER_SAGA_NAME, outboxStatus);
    }
    @Transactional
    ...
    private void save(OrderOutboxMessage orderOutboxMessage) {
        final var response = orderOutboxRepository.save(orderOutboxMessage);
        if (response == null) {
    ...
    public void updateOutboxMessage(OrderOutboxMessage orderOutboxMessage,
        ...
        log.info("Order outbox table status is updated as {}",
                outboxStatus.name());
    }
}
