...
public class OrderOutboxScheduler implements OutboxScheduler {
    ...
    private final RestrntApprovalResponseMessagePublisher responseMessagePublisher;

    public OrderOutboxScheduler(OrderOutboxHelper orderOutboxHelper, RestrntApprovalResponseMessagePublisher responseMessagePublisher) {
