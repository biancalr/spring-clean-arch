...
public class ApprovalOutboxHelper {
    ...
    private String createPayload
        ...
        try {
            ...
            log.error("Could not create OrderApproval payload for order id {}",
                    orderApprovalEventPayload.getOrderId(), e);
            throw new OrderDomainException("Could not create OrderApproval payload for order id " +
                    orderApprovalEventPayload.getOrderId(), e);
        }
    }
}
