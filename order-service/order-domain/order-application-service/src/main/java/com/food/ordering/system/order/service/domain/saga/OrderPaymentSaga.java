...
public class OrderPaymentSaga implements SagaStep<PaymentResponse, OrderPaidEvent, EmptyEvent> {
    ...
    public OrderPaymentSaga(OrderDomainService orderDomainService, OrderRepository orderRepository, OrderPaidRestaurantRequestMessagePublisher orderPaidRestaurantRequestMessagePublisher, OrderSagaRepositoryHelper orderSagaRepositoryHelper) {
    ...
    public OrderPaidEvent process(PaymentResponse paymentResponse) {
        ...
        Order order = orderSagaRepositoryHelper.findOrder(paymentResponse.getOrderId());
