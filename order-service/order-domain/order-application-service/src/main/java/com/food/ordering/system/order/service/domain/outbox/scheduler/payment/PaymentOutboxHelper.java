...
public class PaymentOutboxHelper {
    ...
    public void save(OrderPaymentOutboxMessage orderPaymentOutboxMessage) {
        ...
        if (response == null) {
            log.error("Could not save OrderPaymentOutboxMessage with outbox with id {}", orderPaymentOutboxMessage.getId());
            throw new OrderDomainException("Could not save OrderPaymentOutboxMessage with outbox with id "
    ...
    private String createPayload(final OrderPaymentEventPayload paymentEventPayload) {
        try {
