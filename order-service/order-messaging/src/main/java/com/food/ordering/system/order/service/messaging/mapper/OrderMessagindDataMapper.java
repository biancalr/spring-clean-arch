...
public class OrderMessagindDataMapper {
    ...
    public PaymentRequestAvroModel orderCreatedEventToPaymentRequestApprovalModel(
    ...
    public PaymentRequestAvroModel orderCancelledEventToPaymentRequestApprovalModel(
    ...
    public PaymentResponse paymentResponseAvroModelToPaymentResponse(
            final PaymentResponseAvroModel paymentResponseAvroModel) {
    ...
    public RestaurantApprovalResponse approvalResponseAvroModelToApprovalResponse(
        ...
        return RestaurantApprovalResponse.builder()
                ...
                .createdAAt(restaurantApprovalResponseAvroModel.getCreatedAt())
                .createdAAt(restaurantApprovalResponseAvroModel.getCreatedAt())
